...
plugins {
    ...
    alias(libs.plugins.ktlint) // ktlint
    ...
    reports {
        total {
            ...
            verify {
                onCheck = true
                rule {
                    minBound(70) // Minimum 70% coverage
                }
            }
            filters {
                excludes {
                    // Exclude UI and IntelliJ Platform integration code from coverage
                    packages(
                    ...
                    classes(
                        ...
                        "com.github.andrelmv.kotbox.proto.dialog.PlacementDialog",
                        "com.github.andrelmv.kotbox.proto.dialog.PlacementStrategy*",
                        "com.github.andrelmv.kotbox.proto.dialog.PreviewDialog*",
